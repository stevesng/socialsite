...
alter table userapi_user add constraint userapi_user_c1 unique(username(40));
create index userapi_user_index1 on userapi_user(userid(40));
create index userapi_user_index2 on userapi_user(username(40));

create table userapi_userrole (
    id                   varchar(48) not null primary key,
    rolename             varchar(255) not null
);
alter table userapi_userrole add constraint userapi_userrole_c1 unique(rolename(40));
...
create index userapi_user_userrole_index1 on userapi_user_userrole(user_id(40));
