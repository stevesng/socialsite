...
/**
 * Encapsulates SocialSite database configuration via JDBC properties or JNDI.
 *
 ...
 * information to whomever is installing SocialSite.</p>
 *
 *
 * <p>Reads configuration properties from Config:</p>
 * <pre>
 * # Specify database configuration type of 'jndi' or 'jdbc'
 * database.configurationType=jndi
 *
 * # For database configuration type 'jndi',this will be used
 * database.jndi.name=jdbc/socialsitedb
 *
