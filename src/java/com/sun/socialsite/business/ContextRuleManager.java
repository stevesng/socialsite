...
import com.sun.socialsite.business.impl.JPAContextRuleManagerImpl;
import com.sun.socialsite.pojos.ContextRule;
import java.util.List;

/**
 * Create and manage context rules that allow/reject access
 * to SocialSite widgets in other applications.
 */
@ImplementedBy(JPAContextRuleManagerImpl.class)
public interface ContextRuleManager extends Manager {
