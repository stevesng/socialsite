...
import com.sun.socialsite.business.impl.JPAThemeSettingsManagerImpl;
import com.sun.socialsite.pojos.ThemeSettings;
import java.util.List;


/**
 * Manages ThemeSettings.
 */
@ImplementedBy(JPAThemeSettingsManagerImpl.class)
public interface ThemeSettingsManager extends Manager {

    public void createThemeSettings(String dest, String anchor,
            String bgColor, String bgImage, String font) throws SocialSiteException;
