...
/**
 * A do-nothing implementation of the <code>ExtensionManager</code>
 * interface.
 */
public class NullExtensionManager implements ExtensionManager {
    ...
    /*
     * Log a message in case someone is trying to use the SocialSite.get()
     * method without a working implementation of the interface.
     */
    public <T extends Manager> T getManager(Class<T> c) {
        log.warn(
            "NullExtensionManager should not be used. Returning null.");
        return null;
    }
}
