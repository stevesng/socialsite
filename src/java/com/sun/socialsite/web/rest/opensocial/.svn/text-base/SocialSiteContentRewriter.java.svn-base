...
/**
 * Override default so we can return correct proxy and concat URLs.
 */
public class SocialSiteContentRewriter { // extends DefaultContentRewriter {
/*
    @Inject
    public SocialSiteContentRewriter(
    ...
    protected String getConcatUrl() {
        return Factory.getSocialSite().getURLStrategy().getBaseURL() + super.getConcatUrl();
    }

    @Override
    protected String getProxyUrl() {
        return Factory.getSocialSite().getURLStrategy().getBaseURL() + super.getProxyUrl();
    }
*/
}
