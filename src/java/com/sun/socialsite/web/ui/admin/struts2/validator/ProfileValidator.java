...
/**
 * Used by multiple actions to check if a profile ID is
 * valid or not.
 */
public class ProfileValidator extends AbstractValidatorSupport {
    ...
    public void validate(Object o) throws ValidationException {
        ...
        try {
            ...
            if (mustExist && profile == null) {
                addFieldErrorWithMessage(fieldName, o,
                    "socialsite.form.userid.unknown", id);
            } else if (!mustExist && profile != null) {
                addFieldErrorWithMessage(fieldName, o,
                    "socialsite.form.userid.exists", id);
            }
