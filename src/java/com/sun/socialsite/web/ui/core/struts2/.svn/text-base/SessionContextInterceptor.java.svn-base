...
public class SessionContextInterceptor extends AbstractInterceptor {
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
       ...
       if (action instanceof CustomizedActionSupport) {
           CustomizedActionSupport a = (CustomizedActionSupport)action;
           a.userId = ServletActionContext.getRequest().getRemoteUser();
       }
