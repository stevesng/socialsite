...
<script type="text/javascript">
 socialsite.setContext({
   ...
   'delegate': {
     'method': 'GET',
     'url': '<%=request.getScheme()%>://<%=request.getServerName()%>:<%=request.getServerPort()%><%=request.getContextPath()%>/socialsite_context.jsp?group=${groupHandle}',
     'headers': {
...
<script type="text/javascript">
 socialsite.addGadget({'spec':'/local_gadgets/group_profile.xml', 'removable':false});
 ...
 socialsite.addGadgets({'collection':'GROUP'});
</script>
